use polkavm_derive::polkavm_import;
...
extern "C" {
    ...
    #[polkavm_import(index = 27)]
    pub fn export_memory_regions(regions_ptr: u64, len: u64);

    #[polkavm_import(index = 28)]
    pub fn export_program_result(result_ptr: u64, inst_cnt: u64);

    #[polkavm_import(index = 29)]
    pub fn export_parameter_bytes(bytes_ptr: u64, len: u64);
}
